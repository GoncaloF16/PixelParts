        ...
        <aside class="w-64 bg-gray-900 text-white flex flex-col">
            ...
            <nav class="flex-1 p-4">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="/backoffice/stock" class="nav-link {{ request()->is('backoffice/stock') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="/backoffice/users" class="nav-link {{ request()->is('backoffice/users') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-4 border-t border-gray-700">
                <button class="w-full flex items-center gap-3 px-4 py-2 text-gray-300 hover:bg-gray-800 rounded-lg transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

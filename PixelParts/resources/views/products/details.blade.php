    ...
    <div class="container mx-auto px-6">
        ...
        <div class="w-full">
            <div class="bg-surface-elevated border border-white/10 p-1 rounded-lg grid grid-cols-4 mb-8">
                ...
                <button class="tab-btn px-6 py-3 rounded-lg font-semibold transition-all" data-tab="features">Características</button>
                <button class="tab-btn px-6 py-3 rounded-lg font-semibold transition-all" data-tab="compatibility">Compatibilidade</button>
                <button class="tab-btn px-6 py-3 rounded-lg font-semibold transition-all" data-tab="reviews">Avaliações ({{ $product->reviews->count() }})</button>
            </div>
                ...
                <div class="flex justify-between items-center mb-8 flex-wrap gap-4">
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <span class="text-white text-text-inverse text-xl font-bold">{{ number_format($averageRating, 1) }} de 5</span>
                        </div>
                    </div>

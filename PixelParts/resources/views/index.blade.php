                     ...
                     <div
                         ...
                         <div class="bg-gray-900 text-white pt-4 pb-5 px-4 flex flex-col flex-1 min-h-0">
                             ...
                             <div class="flex items-center justify-between">
                                 ...
                                 <button
                                     class="bg-gradient-to-r from-brand-green to-brand-blue text-surface-dark px-3 py-1 rounded-md font-semibold text-sm hover:scale-105 transition-transform duration-300 glow-brand flex items-center gap-1">
